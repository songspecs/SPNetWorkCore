...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of SPNetWorkCore.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/songpu_work@163.com/SPNetWorkCore'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'songpu_work@163.com' => 'songpu_work@163.com' }
  s.source           = { :git => 'https://github.com/songpu_work@163.com/SPNetWorkCore.git', :tag => s.version.to_s }
